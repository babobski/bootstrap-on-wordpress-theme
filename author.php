...
<h1><?php echo __('Author Archives:', 'wp_babobski'); ?> <?php echo get_the_author() ; ?></h1>

<?php if ( get_the_author_meta( 'description' ) ) : ?>
<?php echo get_avatar( get_the_author_meta( 'user_email' ) ); ?>
<h2><?php echo __('About', 'wp_babobski'); ?> <?php echo get_the_author() ; ?></h2>
...
<?php else: ?>
<h2><?php echo __('No posts to display for', 'wp_babobski'); ?> <?php echo get_the_author() ; ?></h2>	
<?php endif; ?>
